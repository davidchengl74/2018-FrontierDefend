...
#define URL_SERVER  (GAME()->_serverThread._urlForOdata)
#endif
//#define URL_SERVER_REAL_TEST    "http://e08c2a70dc504887b45c9c95007891ea.cloudapp.net/WATMmonitorfile.htm"
//#define URL_SERVER_REAL     "http://e08c2a70dc504887b45c9c95007891ea.cloudapp.net/api/TapDefense/"

#define URL_SERVER_REAL_TEST    "http://odata.tpd.pine-entertainment.com/WATMmonitorfile.htm"
#define URL_SERVER_REAL     "http://odata.tpd.pine-entertainment.com/api/TapDefense/"
...
#else
#define DT()			(CGame::_this->_oldFrameDT)
#endif
...
#define PLAY_SFX(id)	(Device::PlayQueueSFX(id))
