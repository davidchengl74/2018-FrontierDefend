...
public class PineNotificationManager {
    ...
    public static void init (Activity activity, int iconId)
    {
        ...
        try {
            ...
            Intent notificationIntent = new Intent(AppContext.CurrentContext, FrontierDefenseAlarmReceiver.class);
            ...
            mCurrentBroadcast = PendingIntent.getBroadcast(mCurrentActivity, 575453, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
