...
#define GAME_PROMO_RENDER_X		15
#define GAME_PROMO_RENDER_Y		(130)
...
public:
	...
	void InitGamePromo(float x, float y, int w, int h, enumTypeTopeboxAds type_ads, enumTopeboxAdsPos pos);
	...
	void SetDataAds(char game_name[], char link_store[], char link_icon[], char game_id[]);
	...
	enumTopeboxAdsPos _pos_topebox_ads =  enumTopeboxAdsPos::TOP_RIGHT;
