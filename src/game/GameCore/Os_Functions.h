...
extern "C" void			OS_GoogleAnalyticsSetUserProperty(const char *id, const char * value = "");
...
#if defined (ANDROID_OS)
/*NOTSURE*/			extern "C" void			OS_AsynFacebookLoadFriendIdList(PineServiceHandle* hsvc, PineAccountInfoList* account_list);
#else
...
extern "C" void OS_AsynTapdaqInterstitialShow(PineServiceHandle* svc);

extern "C" void OS_AsynTapdaqBannerPrepare(PineServiceHandle* svc, bool auto_show, const char* ad_id);
extern "C" void OS_AsynTapdaqBannerShow(PineServiceHandle* svc);
extern "C" void OS_AsynTapdaqBannerHide(PineServiceHandle* svc);

extern "C" void OS_AsynTapdaqRewardedVideoPrepare(PineServiceHandle* svc);
extern "C" void OS_AsynTapdaqRewardedVideoShow(PineServiceHandle* svc);
