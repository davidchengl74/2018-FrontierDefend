...
ENUM PineServiceCode
{
	...
	FirebaseAnalyticsSetUserProperty = 60,

	//Local notification
	SetLocalNotification = 61,

	//Game Spark back-end
	GameSparkLogin = 62,
	GameSparkPostScore = 63,
	GameSparkGetLeaderBoard = 64,
	GameSparkGetSave = 65,
	GameSparkUploadSave = 66,

	//tapdaq
	TapdaqInterstitialPrepare = 67,
	TapdaqInterstitialShow = 68,
	TapdaqBannerPrepare = 69,
	TapdaqBannerShow = 70,
	TapdaqBannerHide = 71,
	TapdaqRewardedVideoPrepare = 72,
	TapdaqRewardedVideoShow = 73,
	
	FirebaseDownloadConfig = 74,
